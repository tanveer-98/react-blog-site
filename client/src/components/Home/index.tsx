...
const index = () => {
  ...
  return (
    <div className={` mt-[90px] w-full h-full px-10 flex-col bg-darkImg  bg-scroll flex justify-center mx-auto`} >
      ...
      <div>
      <h3 className=" mt-10  text-3xl md:text-5xl border-b-2 pb-5 text-black"> Suggested Blogs </h3>
      <hr />
      ...
      <h3 className=" mt-10  text-3xl md:text-5xl border-b-2 pb-5 text-black"> Your Blogs</h3>
      <hr />
